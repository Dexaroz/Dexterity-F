...
public class AddBillFormCommand implements Command {
    ...
    public AddBillFormCommand(Object parentFrame, BillManager billManager, BillFormDialogFactory billFormDialogFactory, Map<String, Command> commands) {
